          ...
          <div class="card">
              <div class="card">
                  <div class="card-body table-scrollable info-card">
					...
					<form:form method="POST" action="../sendEmailCR">
                    <table id="trainingInfo" class="table">
                        ...
                        <tbody>
							...
							<tr hidden="true">
                            	<td><form:input name="location" path="ct_proposed_location" readonly="true" style="width:100%; height:100%;"/></td>
							</tr>
							 <tr hidden = "true">
                            	<td><form:input name="allocatedexec" path="ct_assigned_exec" readonly="true" style="width:25%; height:100%;"/></td>
							</tr>
                            <tr>
                            	<td><input name="address" placeholder="Address" style="width:25%; height:100%;"/></td>
							</tr>
						</tbody>
                      </table>
