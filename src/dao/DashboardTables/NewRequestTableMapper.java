...
public class NewRequestTableMapper implements RowMapper<NewRequestTable>{

	@Override
	public NewRequestTable mapRow(ResultSet result, int arg1) throws SQLException {
		NewRequestTable objRF = new NewRequestTable();
