...
public class RequestInQueueTableMapper implements RowMapper<RequestInQueueTable>{

	@Override
	public RequestInQueueTable mapRow(ResultSet result, int arg1) throws SQLException {
		RequestInQueueTable objRF = new RequestInQueueTable();
