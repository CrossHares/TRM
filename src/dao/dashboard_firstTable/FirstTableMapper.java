...
public class FirstTableMapper implements RowMapper<FirstTable>{

	@Override
	public FirstTable mapRow(ResultSet result, int arg1) throws SQLException {
		FirstTable objRF = new FirstTable();
