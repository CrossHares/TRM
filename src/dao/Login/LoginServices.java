...
public class LoginServices {
	...
	public Login isUserValid(String user, String pass)
	{
		JdbcTemplate temp = MyJDBCTemplate.getJdbcTemplate();
		
		List<Login> userList =  temp.query("select ld_user_name, ur_name, ld_user_email from ld_team, user_role where ld_user_name = ? and ld_user_password = ? and ld_team.ur_id = user_role.ur_id",
