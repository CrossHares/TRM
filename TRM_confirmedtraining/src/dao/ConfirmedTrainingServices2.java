...
public class ConfirmedTrainingServices2 {
	...
	//Read
	public List<ConfirmedTraining2> readCT()
	{
		List<ConfirmedTraining2> list = temp.query("select * from CONFIRMED_TRAINING", new ConfirmedTrainingMapper2());
		return list;
	}
	
	//Update
	public int updateCT( int tsID, int ttID, String ldUserEmail, int verID, String trfIDs, String ctStartDate, String ctEndDate, 
			String ctStartTime, String ctEndTime, String ctTechnology, String ctTrainingObj, String ctLocation, String ctNomFile, int ctID)
	{
		System.out.println("-------------------*****************************");;
	...
	public ConfirmedTraining2 getCT(int ctID)
	{
		ConfirmedTraining2 ct = (ConfirmedTraining2)temp.queryForObject("select * from CONFIRMED_TRAINING where CT_ID=?", 
				new Object[]{ctID}, new ConfirmedTrainingMapper2());
		return ct;
	}
	
	public static void main(String args[])
	{
		ConfirmedTrainingServices2 ctSvcs = new ConfirmedTrainingServices2();
		//ctSvcs.updateCT(ctID, tsID, ttID, ldUserEmail, verID, trfIDs, ctStartDate, ctEndDate, ctStartTime, ctEndTime, ctTechnology, ctTrainingObj, ctLocation, ctNomFile)
